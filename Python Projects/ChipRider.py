...
while(True):
    ...
    if(opt == "1"):
        ...
        if(credits == 30):
            ...
            while(True):
                print("You can buy a maximum of ", 30-credits," credts. How much would you like to add?(By the way, if you add negetive credits, you lose credits and that's your problem)")
                try:
                    cre = int(input())
                except ValueError:
